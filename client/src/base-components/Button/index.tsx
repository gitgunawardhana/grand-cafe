...
export const Button = <E extends React.ElementType = "a">({
  ...
  // General Styles
  const generalStyles = [
    "max-w-fit transition duration-200 border shadow-sm inline-flex items-center justify-center rounded-md font-medium cursor-pointer inline-flex items-center justify-center text-base font-medium text-gradient-yellow-300 bg-gradient-yellow-300 hover:text-gradient-yellow-300 hover:bg-gradient-yellow-300", // Default
