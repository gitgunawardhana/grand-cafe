...
const Main = () => {
  return (
    <>  <div className="ml-[325px] mr-52 mt-0!m-auto flex flex-col justify-center object-cover px-12 text-center text-gradient-yellow-300 md:px-28 lg:px-32">
        ...
        <div className="ml-[25px] col-span-2 mt-5 justify-start text-start text-[20px] font-extrabold text-gradient-yellow-900 sm:text-[25px] md:text-[30px] lg:text-[45px]">
        ...
        <textarea  rows={5} cols={20} className=" rounded-md block p-2.5 w-full text-sm opacity-0 border border-gradient-yellow-900"></textarea>
        </div>
            </div>
            </div>
    </>
